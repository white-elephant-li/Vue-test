    ...
    <div class="goods-detail-content">
        <parallax @onScrollChange="onScrollChange">
            ...
            <template v-slot:parallax-slow>
                <!-- 轮播 -->
                <my-swiper :height="SWIPER_IMAGE_HEIGHT + 'px'" :swiperImgs="swiper_img" :paginationType="'2'"></my-swiper>
            </template>
                 ...
                 <div class="goods-detail-content-desc">
                    <div class="goods-detail-content-desc-item">
                        ...
                        <p class="goods-detail-content-desc-item-name">
                            <direct v-if="goodsData.direct"></direct>
                            {{goodsData.name}}
                        </p>
                    </div>
                    ...
                    <div class="goods-detail-content-desc-detail">
                        <img v-for="(item, index) in detailimg" :key="index" :src="item.img" alt="" srcset="">
                    </div>
                </div>
            </template>
        </parallax> 
...
export default {
    ...
    created: function () {
        ...
        this.detailimg = this.goodsData.detailsImg;
        this.swiperimg = this.goodsData.swiperImg;
        
        for (let key in this.swiperimg){
            this.swiper_img.push(this.swiperimg[key].img)
        }
    },
    methods: {
